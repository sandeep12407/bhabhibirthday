...
var canvas = document.getElementById("canvas1"),
    ...
    keyword2 = "JYOTI BHABHISA",
    keyword3 = "Clear Screen By Touching Me And Wait",
    imageData,
    density =1,
    mouse = {},
    hovered = false,
...
//   );
  ...
  let w = (c.width = window.innerWidth),
    ...
    hh = h / 2,
    opts = {
      //strings_1: [['生日快乐，','JYOTI BHABHIJI'], ['在新的一年里，','要开心，要勇敢，要快乐'], ['愿所有的幸福，温馨，好运..'],['都在你身边'], ['也不要忘了，你还有一个朋友一直会陪伴你'],['现在就让可爱的小黄人','来为你庆祝生日吧哈哈哈哈']],
      //strings_1: [['生日快乐!','JYOTI BHABHIJI'], ['送你一句话哈哈'],[' 但愿你的眼睛, 只看得到笑容'],['但愿你流下每一滴泪,','都让人感动'],['但愿你以后每一个梦,','不会一场空'],['还有,'],['不要忘了','你有个朋友会一直陪伴你'],['现在,'],[' 就让小黄人,','为你庆祝生日吧哈哈哈哈']],
      //strings_1:[['生日快乐!','JYOTI BHABHIJI'],['今天有了你世界更精彩'], ['今天有了你星空更灿烂'],['今天因为你人间更温暖'], ['今天因为你,', '我觉得更幸福!'],['现在,'],[' 就让小黄人,','为你庆祝生日吧哈哈哈哈']],
      // strings_1: [['四季的风吹动了',' 岁月的风铃,'],['奏响为你生日祝福的歌'],['生日快乐!!', 'JYOTI BHABHIJI',], ['新的一岁里,','愿灿烂阳光照亮你所有的日子'], ['愿美丽的鲜花,','开遍你要走过的每个地方'],['新的一岁，','要开心,要快乐,要幸福'],[' 也请不要忘了,','有一个朋友一直都在你身边'],['现在,'],[' 就让小黄人..','为你庆祝生日吧哈哈哈哈']],
      // strings_1: [['四季的风吹动了',' 岁月的风铃,'],['奏响为你生日祝福的歌'],['生日快乐!!', 'JYOTI BHABHIJI',], ['新的一岁里,','愿灿烂阳光照亮你所有的日子'], ['愿美丽的鲜花,','开遍你要走过的每个地方'],['新的一岁，','要开心,要快乐,要幸福'],['现在,'],[' 就让小黄人..','为你庆祝生日吧哈哈哈哈']],
      // strings_1: [['四季的风吹动了',' 岁月的风铃,'],['奏响为你生日祝福的歌'],['生日快乐!!', 'JYOTI BHABHIJI',], ['新的一岁里,','愿灿烂阳光照亮你所有的日子'], ['愿美丽的鲜花,','开遍你要走过的每个地方'],['新的一岁，','要开心,要快乐,要幸福'],['现在,'],[' 就让小黄人..','为你庆祝生日吧哈哈哈哈']],
//今天有了你世界更精彩，今天有了你星空更灿烂，今天因为你人间更温暖，今天因为你我觉得更幸福!祝你生日快乐!
      //用最激动的心情，编辑一条短信，在这个时刻为你送上，因为今天是你的生日，距离再远，也无法阻隔想要对你说，生日快乐。
      strings_1: [["  Happy birthday!", "  JYOTI BHABHIJI  "], ["   May all happiness,"], ["all luck"], [" always surround", "you  "], ["  Now welcome the", "    Minions to celebrate", "   your birthday haha~"]],
